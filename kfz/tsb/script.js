...
function updateColor() {
    ...
    divs.innerText = "十六进制颜色代码：" + divs.innerText;
...
function updateColorFromPicker() {
    ...
    var divs = document.getElementById("colorCode");
    divs.innerText = "十六进制颜色代码：" + selectedColor;
    var divs = document.getElementById("colorCode2");
    divs.innerText = "迷你世界颜色代码：#c" + capitalizeText(selectedColor.substring(1, 7));
}
