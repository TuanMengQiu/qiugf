	...
	var y = {
		...
		H = function(e) {
			e.commands.addCommand({
				...
				exec: function() {
					            const iframe = document.querySelector('#devWiki iframe'); //改wiki
            // 替换下面的URL为你要跳转的链接
            // window.open('https://tuanmengqiu.cn/kfz/cxid/', '_blank');
      if (isAPI2) {
        iframe.src = 'https://tuanmengqiu.cn/kfz/cxid/';
